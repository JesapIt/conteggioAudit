...
,'Progetto interno', 'Formazione', 'Call con HR buddy', 'Organizzazione area', 'Task interno', 'Evento', 'Revisione Task', 'Report d\'area', 'Altri report', 'Auditing progetto', 'PowerBI']
