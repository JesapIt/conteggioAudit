...
,'Progetto interno', 'Formazione', 'Call con HR buddy', 'Organizzazione area', 'Delega', 'Task interno', 'Altro', 'Evento', 'Revisione Task', 'Report d\'area', 'Altri report', 'Auditing progetto', 'PowerBI', 'Board Resp/Resp Vice', 'Case study']
